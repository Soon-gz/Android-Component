    ...
    void apply(Project project) {
        ...
        if (isRunAlone) {
            ...
            if (assembleTask.isAssemble && module.equals(compilemodule)) {
                ...
                project.android.registerTransform(new CustomBuildGradleTransform(project))
            }
        } else {
        ...
        System.out.println("========================== " + module + "  BuildGradlePlugin end ===============================")
    }
    ...
    private void compileComponents(AssembleTask assembleTask, Project project) {
        ...
        for (String str : compileComponents) {
            ...
            if (str.contains("@aar")) {
                 ...
                 * compileComponent=com.netseae.plugin:up:1.0.0
                 * 从本地仓库加载
                 */
                project.dependencies.add("api", str.replace("@aar", ""))
                System.out.println("add dependencies lib  : " + str.replace("@aar", ""))
            } else {
                /**
                 * 示例语法:module
