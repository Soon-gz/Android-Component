package com.example.commonbasiclibrary.router;
...
public class Router {
    ...
    //注册的组件的集合
    private static HashMap<String, IApplicationInject> components = new HashMap<>();
    ...
    public static void registerComponent(@Nullable String classname) {
        ...
        try {
            ...
            IApplicationInject applicationLike = (IApplicationInject) clazz.newInstance();
